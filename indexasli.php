                ...
                <div class="resource-group">
                    ...
                    <div class="endpoints-container">
                        <div class="endpoint-card">
                            ...
                            <span class="url">http://localhost/hospita_api/patients/index.php</span>
                            <span class="desc">Ambil semua pasien</span>
                            <button class="copy-btn"
                                data-url="http://localhost/hospital_api/patients/index.php">Copy</button>
                            <button class="try-btn"
                                onclick="tryThisEndpoint('GET', 'http://localhost/hospital_api/patients/index.php', null)">🔥
                                Try</button>
                        </div>
                        <div class="endpoint-card">
                            <span class="method get">GET</span>
                            ...
                            <button class="copy-btn"
                                data-url="http://localhost/hospital_api/patients/detail.php?id=1">Copy</button>
                            <button class="try-btn"
                                onclick="tryThisEndpoint('GET', 'http://localhost/hospital_api/patients/detail.php', 'id=1')">🔥
                                Try</button>
                        </div>
                        <div class="endpoint-card">
                            <span class="method get">GET</span>
                            ...
                            <button class="copy-btn"
                                data-url="http://localhost/hospital_api/patients/index.php?search=nama">Copy</button>
                            <button class="try-btn"
                                onclick="tryThisEndpoint('GET', 'http://localhost/hospital_api/patients/index.php', 'search=nama')">🔥
                                Try</button>
                        </div>
                        <div class="endpoint-card">
                            ...
                            <button class="copy-btn"
                                data-url="http://localhost/hospital_api/patients/index.php">Copy</button>
                            <button class="try-btn"
                                onclick="tryThisEndpoint('POST', 'http://localhost/hospital_api/patients/index.php', null, '{\n    "
                        ...
                        <div class="endpoint-card">
                            ...
                            <button class="copy-btn"
                                data-url="http://localhost/hospital_api/patients/detail.php?id=1">Copy</button>
                            <button class="try-btn"
                                onclick="tryThisEndpoint('PUT', 'http://localhost/hospital_api/patients/detail.php', 'id=1', '{\n    "
                                name": "Nama Update" ,\n "phone" : "08987654321" ,\n "address" : "Alamat Baru" \n}')">🔥
                                Try</button>
                        </div>
                        <div class="endpoint-card">
                            ...
                            <button class="copy-btn"
                                data-url="http://localhost/hospital_api/patients/detail.php?id=1">Copy</button>
                            <button class="try-btn"
                                onclick="tryThisEndpoint('DELETE', 'http://localhost/hospital_api/patients/detail.php', 'id=1')">🔥
                                Try</button>
                        </div>
                    </div>
                </div>
                ...
                <div class="resource-group">
                    ...
                    <div class="endpoints-container">
                        <div class="endpoint-card">
                            ...
                            <button class="copy-btn"
                                data-url="http://localhost/hospital_api/doctors/index.php">Copy</button>
                            <button class="try-btn"
                                onclick="tryThisEndpoint('GET', 'http://localhost/hospital_api/doctors/index.php', null)">🔥
                                Try</button>
                        </div>
                        <div class="endpoint-card">
                            <span class="method get">GET</span>
                            ...
                            <button class="copy-btn"
                                data-url="http://localhost/hospital_api/doctors/detail.php?id=1">Copy</button>
                            <button class="try-btn"
                                onclick="tryThisEndpoint('GET', 'http://localhost/hospital_api/doctors/detail.php', 'id=1')">🔥
                                Try</button>
                        </div>
                        <div class="endpoint-card">
                            <span class="method post">POST</span>
                            ...
                            <button class="copy-btn"
                                data-url="http://localhost/hospital_api/doctors/index.php">Copy</button>
                            <button class="try-btn"
                                onclick="tryThisEndpoint('POST', 'http://localhost/hospital_api/doctors/index.php', null, '{\n    "
                ...
                <div class="resource-group">
                    ...
                    <div class="endpoints-container">
                        <div class="endpoint-card">
                            ...
                            <button class="copy-btn"
                                data-url="http://localhost/hospital_api/appointments/index.php">Copy</button>
                            <button class="try-btn"
                                onclick="tryThisEndpoint('GET', 'http://localhost/hospital_api/appointments/index.php', null)">🔥
                                Try</button>
                        </div>
                        <div class="endpoint-card">
                            <span class="method post">POST</span>
                            ...
                            <button class="copy-btn"
                                data-url="http://localhost/hospital_api/appointments/index.php">Copy</button>
                            <button class="try-btn"
                                onclick="tryThisEndpoint('POST', 'http://localhost/hospital_api/appointments/index.php', null, '{\n    "
                        ...
                        <div class="endpoint-card">
                            ...
                            <button class="copy-btn"
                                data-url="http://localhost/hospital_api/appointments/detail.php?id=1">Copy</button>
                            <button class="try-btn"
                                onclick="tryThisEndpoint('PUT', 'http://localhost/hospital_api/appointments/detail.php', 'id=1', '{\n    "
                                status": "done" \n}')">🔥 Try</button>
                        </div>
                    </div>
                </div>
...
function checkLoginStatus() {
    ...
    // Auto logout jika terdeteksi isLoggedIn tapi apiKey tidak ada
...
function tryThisEndpoint(method, url, params, body) {
    ...
    document.getElementById('try-body').value = body ? body : '';
...
async function sendRequest() {
    ...
    // Tambahkan API Key hanya jika sudah login
    const apiKey = localStorage.getItem('apiKey');
    if (apiKey) {
...
async function doRegister() {
    ...
    try {
        // KIRIM TANPA HEADER API KEY (karena belum punya)
        const response = await fetch('login_api.php', {
            method: 'POST',
            headers: { 'Content-Type': 'application/json' },
            body: JSON.stringify({
